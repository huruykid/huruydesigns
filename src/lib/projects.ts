...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Transforming HCM with a unified portal for seamless HR management.",
    impact: "Unified HR management for enterprise teams",
    tags: ["Enterprise UX", "HCM", "Figma", "B2B"],
    role: "UX Designer, UX Researcher, Stakeholder Presentation",
    timeline: "6+ months",
    tools: ["Figma", "Ionic", "Jira"],
    challenge: "HR teams were juggling disconnected portals for time & attendance, benefits, payroll, and more — creating friction, confusion, and costly errors across the entire workforce.",
    problem: "The goal was to create a seamless user experience for individuals interacting with diverse aspects of HR management, ranging from time and attendance to benefits and payroll. The challenge involved addressing disparate user interfaces, ensuring consistency, and simplifying complex workflows.",
    problemBullets: [
      "Disparate portals for Time & Attendance, Benefits, Payroll with no unified experience",
      "Inconsistent UI patterns causing user confusion and steep learning curves",
      "Complex, unintuitive workflows leading to admin errors",
      "No single sign-on — users forced to manage multiple entry points",
      "Outdated visual design difficult to demonstrate to clients",
    ],
    solution: "Through a unified design approach, we successfully consolidated the Asure HCM portal to seamlessly integrate diverse HR functionalities — resulting in enhanced user efficiency, streamlined workflows, and improved overall usability.",
    process: "Conducted software audits, gap analysis, competitive research, user interviews, and iterative prototype testing across a 6+ month engagement.",
    outcomeMetrics: "12 competitive audits. 16 users interviewed. 24 usability tests. 8 design iterations.",
    learnings: [
      "Collaborative design methodologies are essential in enterprise projects. Working closely with developers, product owners, and stakeholders required constantly balancing user needs with technical constraints.",
      "Agile design works. Rapid prototyping and iterative testing allowed the team to catch problems early and ship with confidence.",
      "Cross-functional teamwork breaks down silos. This project shattered preconceived notions about rigid boundaries between design and development.",
      "Stakeholder alignment is a design skill. Presenting findings and design decisions to leadership required translating UX thinking into business outcomes.",
    ],
    nextSteps: [
      "Conduct user and sales rep feedback sessions to gather post-launch insights",
      "Expand portal features based on continuous feedback loops",
      "Ensure satisfaction across both end users and the sales team",
